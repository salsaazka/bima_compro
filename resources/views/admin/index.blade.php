    ...
    <div class="row">
        <div class="col-12 col-lg-3 col-navbar d-none d-xl-block">
            ...
            <aside class="sidebar">
                ...
                <a href="/dashboard/vismis" class="sidebar-item" onclick="toggleActive(this)">
        ...
        <div class="col-12 col-xl-9">
            <div class="nav">
                <div class="d-flex justify-content-between align-items-center w-100 mb-3 mb-md-0">
                    ...
                    <button class="btn-notif d-block d-md-none"><img src="{{ url('assets/img/global/global/bell.svg') }}" alt=""></button>
                </div>

                <div class="d-flex justify-content-between align-items-center nav-input-container">
                    <div class="nav-input-group">
                        <input type="text" class="nav-input" placeholder="Search people, team, project">
                        <button class="btn-nav-input"><img src="{{ url('assets/img/global/search.svg') }}" alt=""></button>
                    </div>
