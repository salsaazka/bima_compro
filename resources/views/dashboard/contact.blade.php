         ...
         <div class="tab-pane fade" id="profile-tab-pane" role="tabpanel" aria-labelledby="profile-tab" tabindex="0">
            <form method="POST" action="{{ route('store.contact') }}"  enctype="multipart/form-data" class="card py-4 px-4">
                ...
                <div class="mb-3">
                    ...
                    <input type="text" name="address" class="form-control" id="exampleFormControlInput1" placeholder="Input Address">
                    <label for="exampleFormControlInput1" class="form-label">Email</label>
                    <input type="text" name="email" class="form-control" id="exampleFormControlInput1" placeholder="Input Email">
                    <label for="exampleFormControlInput1" class="form-label">No Telphone</label>
                    <input type="text" name="no_telp" class="form-control" id="exampleFormControlInput1" placeholder="Input No Telphone">
                    <label for="exampleFormControlInput1" class="form-label">Web</label>
                    <input type="text" name="web" class="form-control" id="exampleFormControlInput1" placeholder="Input Email">
